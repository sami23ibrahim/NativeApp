  ...
  const signIn = async () => {
    ...
    try {
      ...
      if (!response.user.emailVerified) {
        ...
        navigation.navigate('CreateUser'); // Navigate to CreateUser screen upon successful login
      }
    } catch (error) {
      console.log(error);
...
// import React, { useState } from 'react';
// import { View, TextInput, Button, Alert, ActivityIndicator, StyleSheet, KeyboardAvoidingView } from 'react-native';
// import { signInWithEmailAndPassword, createUserWithEmailAndPassword } from 'firebase/auth';
// import { FIREBASE_AUTH } from '../config/firebase';
...
//       } else {
//         console.log(response);
//         navigation.navigate('MyCategories'); // Navigate to MyCategories screen upon successful login
//       }
//     } catch (error) {
//       console.log(error);
//       Alert.alert('Sign in failed: user not found');
